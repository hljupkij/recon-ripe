...
# Send request to RIPE
    def ripe_request(self, Query, searchType, searchAttr):
...
#        admin_person = self.ripe_request(admin_handle,"person","person")
#        self.output("I did found "+admin_person)
